...
const ::routeguide::Point& Rectangle::_Internal::lo(const Rectangle* msg) {
  return *msg->_impl_.lo_;
}
const ::routeguide::Point& Rectangle::_Internal::hi(const Rectangle* msg) {
...
Rectangle::Rectangle(
  ...
  _impl_.lo_ = (cached_has_bits & 0x00000001u)
                ? CreateMaybeMessage<::routeguide::Point>(arena, *from._impl_.lo_)
                : nullptr;
  _impl_.hi_ = (cached_has_bits & 0x00000002u)
                ? CreateMaybeMessage<::routeguide::Point>(arena, *from._impl_.hi_)
                : nullptr;
...
const ::routeguide::Point& Feature::_Internal::location(const Feature* msg) {
...
Feature::Feature(
  ...
  _impl_.location_ = (cached_has_bits & 0x00000001u)
                ? CreateMaybeMessage<::routeguide::Point>(arena, *from._impl_.location_)
                : nullptr;
...
const ::routeguide::Point& RouteNote::_Internal::location(const RouteNote* msg) {
  return *msg->_impl_.location_;
}
