...
inline void Rectangle::set_allocated_lo(::routeguide::Point* value) {
  ...
  if (message_arena == nullptr) {
    delete reinterpret_cast<::routeguide::Point*>(_impl_.lo_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::routeguide::Point*>(value)->GetArena();
...
inline void Rectangle::set_allocated_hi(::routeguide::Point* value) {
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::routeguide::Point*>(_impl_.hi_);
  }
...
inline void Feature::set_allocated_location(::routeguide::Point* value) {
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::routeguide::Point*>(_impl_.location_);
  }
